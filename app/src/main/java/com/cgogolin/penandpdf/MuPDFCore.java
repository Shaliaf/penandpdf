...
public class MuPDFCore {
    ...
    protected synchronized void init(Context context, String path) throws Exception {
        ...
        if (file_format == null)
            throw new Exception(String.format(context.getString(R.string.cannot_interpret_file), path));
    }
    ...
    protected synchronized void init(Context context, byte buffer[], String fileName) throws Exception {
        ...
        file_format = fileFormatInternal();
        if (file_format == null)
            throw new Exception(String.format(context.getString(R.string.cannot_interpret_file), fileName));
    }
